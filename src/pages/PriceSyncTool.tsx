...
const initialPriceUpdates: PriceUpdate[] = [
  { id: 'pu-001', productId: 'MS-365-E3-001', productName: 'Microsoft 365 E3', distributor: 'INGRAM', currentPrice: 32.00, newPrice: 35.00, percentChange: calcPercent(32.00, 35.00), detectedAt: '2026-01-14T08:00:00Z', status: 'AVAILABLE' },
  { id: 'pu-002', productId: 'WIN-SRV-2022', productName: 'Windows Server 2022 Standard', distributor: 'TD_SYNNEX', currentPrice: 120.00, newPrice: 115.00, percentChange: calcPercent(120.00, 115.00), detectedAt: '2026-01-14T08:00:00Z', status: 'AVAILABLE' },
  { id: 'pu-003', productId: 'AZ-VM-RES-01', productName: 'Azure Reserved VM Instance (D2s v3)', distributor: 'MICROSOFT', currentPrice: 89.00, newPrice: 92.00, percentChange: calcPercent(89.00, 92.00), detectedAt: '2026-01-14T07:30:00Z', status: 'AVAILABLE' },
  { id: 'pu-004', productId: 'D365-SALES-ENT', productName: 'Dynamics 365 Sales Enterprise', distributor: 'ARROW', currentPrice: 65.00, newPrice: 68.00, percentChange: calcPercent(65.00, 68.00), detectedAt: '2026-01-14T06:00:00Z', status: 'AVAILABLE' },
  { id: 'pu-005', productId: 'PBI-PRO-001', productName: 'Power BI Pro', distributor: 'INGRAM', currentPrice: 10.00, newPrice: 9.99, percentChange: calcPercent(10.00, 9.99), detectedAt: '2026-01-14T08:00:00Z', status: 'AVAILABLE' },
  { id: 'pu-006', productId: 'MS-365-BP-001', productName: 'Microsoft 365 Business Premium', distributor: 'TD_SYNNEX', currentPrice: 22.00, newPrice: 24.00, percentChange: calcPercent(22.00, 24.00), detectedAt: '2026-01-13T22:00:00Z', status: 'AVAILABLE' },
  { id: 'pu-007', productId: 'O365-E1-001', productName: 'Office 365 E1', distributor: 'MICROSOFT', currentPrice: 8.00, newPrice: 8.25, percentChange: calcPercent(8.00, 8.25), detectedAt: '2026-01-13T20:00:00Z', status: 'AVAILABLE' },
  { id: 'pu-008', productId: 'INTUNE-001', productName: 'Microsoft Intune Plan 1', distributor: 'ARROW', currentPrice: 8.00, newPrice: 8.50, percentChange: calcPercent(8.00, 8.50), detectedAt: '2026-01-13T18:00:00Z', status: 'AVAILABLE' },
  { id: 'pu-009', productId: 'DEFENDER-BIZ', productName: 'Microsoft Defender for Business', distributor: 'INGRAM', currentPrice: 3.00, newPrice: 2.75, percentChange: calcPercent(3.00, 2.75), detectedAt: '2026-01-13T16:00:00Z', status: 'AVAILABLE' },
  { id: 'pu-010', productId: 'TEAMS-PREM', productName: 'Microsoft Teams Premium', distributor: 'TD_SYNNEX', currentPrice: 10.00, newPrice: 12.00, percentChange: calcPercent(10.00, 12.00), detectedAt: '2026-01-13T14:00:00Z', status: 'AVAILABLE' },
  { id: 'pu-011', productId: 'VISIO-P1', productName: 'Visio Plan 1', distributor: 'MICROSOFT', currentPrice: 5.00, newPrice: 5.50, percentChange: calcPercent(5.00, 5.50), detectedAt: '2026-01-13T12:00:00Z', status: 'AVAILABLE' },
  { id: 'pu-012', productId: 'PROJECT-P3', productName: 'Project Plan 3', distributor: 'ARROW', currentPrice: 30.00, newPrice: 32.00, percentChange: calcPercent(30.00, 32.00), detectedAt: '2026-01-13T10:00:00Z', status: 'AVAILABLE' },
  { id: 'pu-013', productId: 'COPILOT-M365', productName: 'Microsoft 365 Copilot', distributor: 'INGRAM', currentPrice: 30.00, newPrice: 28.00, percentChange: calcPercent(30.00, 28.00), detectedAt: '2026-01-12T08:00:00Z', status: 'AVAILABLE' },
  { id: 'pu-014', productId: 'EXCHANGE-P1', productName: 'Exchange Online Plan 1', distributor: 'TD_SYNNEX', currentPrice: 4.00, newPrice: 4.25, percentChange: calcPercent(4.00, 4.25), detectedAt: '2026-01-12T06:00:00Z', status: 'AVAILABLE' },
  { id: 'pu-015', productId: 'SHAREPOINT-P1', productName: 'SharePoint Online Plan 1', distributor: 'MICROSOFT', currentPrice: 5.00, newPrice: 5.25, percentChange: calcPercent(5.00, 5.25), detectedAt: '2026-01-12T04:00:00Z', status: 'AVAILABLE' },
];

const initialSyncedPrices: PriceUpdate[] = [
  { id: 'sp-001', productId: 'MS-365-E5-001', productName: 'Microsoft 365 E5', distributor: 'INGRAM', currentPrice: 54.00, newPrice: 57.00, percentChange: 5.6, detectedAt: '2026-01-13T08:00:00Z', status: 'SUCCESS', updatedAt: '2026-01-14T09:15:00Z', updatedBy: 'neil.bolton@appdirect.com' },
  { id: 'sp-002', productId: 'WIN-SRV-DC', productName: 'Windows Server 2022 Datacenter', distributor: 'TD_SYNNEX', currentPrice: 350.00, newPrice: 340.00, percentChange: -2.9, detectedAt: '2026-01-13T08:00:00Z', status: 'SUCCESS', updatedAt: '2026-01-14T09:15:00Z', updatedBy: 'neil.bolton@appdirect.com' },
  { id: 'sp-003', productId: 'AZ-SQL-DB', productName: 'Azure SQL Database (Basic)', distributor: 'MICROSOFT', currentPrice: 5.00, newPrice: 4.99, percentChange: -0.2, detectedAt: '2026-01-13T06:00:00Z', status: 'PENDING', updatedAt: '2026-01-14T09:00:00Z', updatedBy: 'neil.bolton@appdirect.com' },
  { id: 'sp-004', productId: 'D365-BASIC', productName: 'Dynamics 365 Business Central Essential', distributor: 'ARROW', currentPrice: 70.00, newPrice: 75.00, percentChange: 7.1, detectedAt: '2026-01-12T08:00:00Z', status: 'FAILED', updatedAt: '2026-01-13T10:00:00Z', updatedBy: 'neil.bolton@appdirect.com', errorMessage: 'Product not found in catalogue. SKU may have been deprecated.' },
  { id: 'sp-005', productId: 'TEAMS-ESS', productName: 'Microsoft Teams Essentials', distributor: 'INGRAM', currentPrice: 4.00, newPrice: 4.50, percentChange: 12.5, detectedAt: '2026-01-12T06:00:00Z', status: 'SUCCESS', updatedAt: '2026-01-12T14:30:00Z', updatedBy: 'admin@appdirect.com' },
  { id: 'sp-006', productId: 'ONEDRIVE-B1', productName: 'OneDrive for Business Plan 1', distributor: 'TD_SYNNEX', currentPrice: 5.00, newPrice: 5.10, percentChange: 2.0, detectedAt: '2026-01-11T08:00:00Z', status: 'SUCCESS', updatedAt: '2026-01-11T16:00:00Z', updatedBy: 'admin@appdirect.com' },
  { id: 'sp-007', productId: 'POWER-APPS', productName: 'Power Apps per User Plan', distributor: 'MICROSOFT', currentPrice: 20.00, newPrice: 21.00, percentChange: 5.0, detectedAt: '2026-01-10T08:00:00Z', status: 'SUCCESS', updatedAt: '2026-01-10T12:00:00Z', updatedBy: 'admin@appdirect.com' },
];
...
const SidebarSection = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div className="mb-6">
    <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 px-4">{title}</h3>
    <div className="space-y-0.5">{children}</div>
  </div>
);

const SidebarItem = ({ label, active = false, onClick }: { label: string; active?: boolean; onClick?: () => void }) => (
  <button
    onClick={onClick}
...
export const PriceSyncTool = () => {
  ...
  const handleConfirmUpdates = () => {
    ...
    setTimeout(() => {
      setSyncedPrices(prev => prev.map(item => {
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-2xl font-normal text-gray-900">Price Sync Tool</h1>
              <p className="text-sm text-gray-500 mt-1">Synchronize product pricing across distributor catalogues</p>
            </div>
