...
import { mockSearchableSubscriptions, getSubscriptionsByIds, calculateTotalValue } from '../../../api/subscriptionData';

// Mock useTransfers hook for demo
function useTransfers() {
  const [submitting, setSubmitting] = useState(false);
  return {
    create: async (_input: { targetPartnerTenantId: string; targetPartnerMpnId?: string; subscriptionIds: string[] }) => {
      setSubmitting(true);
...
export function CreateTransferModal({
  ...
  // Get selected subscriptions using centralized helper
