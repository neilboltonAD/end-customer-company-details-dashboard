    ...
    module: {
      rules: [
        ...
        },
        {
          ...
          exclude: [
            /\.module\.css$/i,
            /src(?![/\\]providers[/\\]MantineProvider)/, // Global css goes there, use at your own peril, you might break customer header branding
          ],
          use: [
            {
              loader: "style-loader",
              options: useShadowRoot
                ? { attributes: { "data-shadow-style": "true" } } // To easily idenitify styles for shadow-root
                : { insert: "#microui-app-styles" },
            },
            "css-loader",
            useShadowRoot
              ? {
